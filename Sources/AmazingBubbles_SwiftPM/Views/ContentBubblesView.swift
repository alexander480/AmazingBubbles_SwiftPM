...
//
//  Modified by Alexander Lester on 3/17/2020.
...
extension ContentBubblesView {
	...
	func removeOddViews(for count: Int) {
	...
	open func removeBehaviors(for view: BubbleView) {
...
public extension ContentBubblesView {
	...
	@objc func handleTap(_ tap: UITapGestureRecognizer) {
		...
		guard let index = bubbleViews.firstIndex(of: bubbleView) else {
